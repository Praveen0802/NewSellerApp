...
const TableView = (props) => {
  ...
  // Update the renderMobileView function in TableView.jsx
            ...
            {loading ? (
              ...
              currentUsers.map((user, index) => (
                <tr key={index} className="hover:bg-gray-100">
                  ...
                  <td className={rowClassName}>{user?.is_primary == 1 ? "Primary" : "Additional"} User</td>
                  <td className={rowClassName}>
                    <div className={`flex gap-2 items-center `}>
                      <button
                        onClick={() => handleEditClick(user)}
                      ...
                      >
                        <IconStore.pencilEdit className="size-4 stroke-2 stroke-[#000000]" />
                      </button>
                      {user?.is_primary != 1 && (
                        <button
                          onClick={() => handleDeleteClick(user)}
                        ...
                        >
                          <IconStore.trash className="size-4 stroke-2 stroke-[#000000]" />
                        </button>
                      )}
                    </div>
                  </td>
