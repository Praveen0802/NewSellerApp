...
const MySalesSubUploadParent = React.forwardRef(
  (
    {
      proofUploadView,
      showInstruction,
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="md:w-[55%] w-full flex flex-col">
          <div className="m-4 flex flex-col overflow-y-auto hideScrollbar flex-1 max-h-[calc(100vh-150px)]">
            ...
            {!proofUploadView && (
              <div className="border-[1px] border-[#E0E1EA] rounded-md mt-4 bg-[#F9F9FB]">
                <div className="p-3 flex items-center gap-2">
                  ...
                  <FloatingSelect
                    ...
                    // error={error}
                    paddingClassName={"whitespace-nowrap w-full px-3 py-2 text-xs border border-[#E0E1EA] rounded-md bg-white text-[#323A70] focus:outline-none focus:ring-2 focus:ring-[#0137D5] focus:border-transparent"}
                    // hideLabel={hideLabel}
...
MySalesSubUploadParent.displayName = "SubUploadParent";

export default MySalesSubUploadParent;
