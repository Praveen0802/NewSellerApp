...
console.log(resultData,'resultDataresultData')
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="overflow-auto p-3 xs:p-4 md:p-6 w-full h-full flex flex-col gap-3 xs:gap-4 md:gap-5 bg-[#F5F7FA]">
        ...
        <div className="flex flex-col lg:flex-row gap-3 xs:gap-4 md:gap-6">
          <div className="w-full lg:w-1/2 flex flex-col gap-3 xs:gap-4 md:gap-6">
